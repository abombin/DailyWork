...
makeAlignment = function(combStats, i) {
  ...
  catFile = paste0("Overlap_Pos_mapping_2/Comb_fasta/",   sampName, ".fasta")
  ...
  system(cmd_str)
  cmd_mafft = paste0("mafft --maxiterate 1000 --thread 4 --globalpair ",  catFile, " > Overlap_Pos_mapping_2/", sampName, "_align.fasta")
  system(cmd_mafft)
}


dir.create("Overlap_Pos_mapping_2/Indecies/", recursive = T, showWarnings = F)
dir.create("Overlap_Pos_mapping_2/Indecies/Ampseq", recursive = T, showWarnings = F)
dir.create("Overlap_Pos_mapping_2/Indecies/Metaseq", recursive = T, showWarnings = F)
...
compileIndex = function(combStats, i, makeCheck) {
  ...
  ampPath = paste0("IntraSnv_ampseq_all/",  ampSample, "/reference.fa")
  metaPath = paste0("IntraSnv_metaseq_all/",  metaSample, "/reference.fa")
  alignmentPath = paste0("Overlap_Pos_mapping_2/", sampName, "_align.fasta")
  ...
  outAmp = paste0("Overlap_Pos_mapping_2/Indecies/Ampseq/", ampSample, ".csv")
  outMeta = paste0("Overlap_Pos_mapping_2/Indecies/Metaseq/", metaSample, ".csv")
...
write.table(combCompChar, "Overlap_index_2.log", row.names = F, col.names = F, quote = F)
