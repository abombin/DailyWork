...
# write.csv(ampseqCons, "IntraSnv_results/ampseq_ConsTest_freq_1_0.csv", row.names = F)
# write.csv(metaseqCons, "IntraSnv_results/metaseq_ConsTest_freq_1_0.csv", row.names = F)
