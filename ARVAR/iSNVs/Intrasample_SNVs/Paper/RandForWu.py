...
df = pd.read_csv('Paper/Additional_analysis/metaseqWu_ConsTest_freq_1_0.csv')
plotname = "WuCons_Metaseq_auc_plot.png"


#df = pd.read_csv('Paper/Additional_analysis/ampseqWu_ConsTest_freq_1_0.csv')
#plotname = "WuCons_Ampseq_auc_plot.png"
...
colOpt5 = ['ALLELE.FREQUENCY', 'STRAND.BIAS', 'QUAL', 'Var_Al_RelPos', 'Ref_Al_RelPos',  'meandepth', 'meanbaseq', 'Sample', 'Samp_Pos_Ref_Alt']
...
#varImportance.to_csv("Paper/Additional_analysis/AmpseqWu_VarImportance.csv", index=False)
#varImportance.to_csv("Paper/Additional_analysis/MetaseqWu_VarImportance.csv", index=False)
...
#sumTest.to_csv("Paper/Additional_analysis/MetaseqWu_ConsTest_freq_1_0_predictSum.csv", index=False)
