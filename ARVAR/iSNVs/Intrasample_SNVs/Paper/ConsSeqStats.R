...
finalAmp = rbind(ampStats, ampOldCombStats)
finalMeta = rbind(metaStats, metaOldCombStats)

write.csv(finalAmp, "Paper/ampseqConsSeqStats.csv", row.names = F)
write.csv(finalMeta, "Paper/metaseqConsSeqStats.csv", row.names = F)