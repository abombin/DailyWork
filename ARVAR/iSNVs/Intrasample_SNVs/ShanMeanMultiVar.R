...
ref = unique(combShannon[, c("Sample", "WHO_variant", "vax_doses_received", "days_post_symptom_onset", "Vaccinated")])
...
DfSel = combShannon[, c("Shannon", "NormShan", "WHO_variant", "vax_doses_received", "Ct_depth_adj", "Vaccinated", "days_post_symptom_onset")]
