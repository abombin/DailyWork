...
png(filename = paste0(targDir,"TimeExpression_Heatmap_", topN, "_", typeGenes, "_2023-12-18.png"), width = 22, height = 22, units = "in", res = 300)
print(curPlot )
dev.off()
...
topN = "AllSign"
typeGenes = "RNA_Linear"
png(filename = paste0(targDir,"TimeExpression_Heatmap_Legend_", topN, "_", typeGenes, "_2023-12-18.png"), width = 22, height = 22, units = "in", res = 300)
print(curPlot )
dev.off()