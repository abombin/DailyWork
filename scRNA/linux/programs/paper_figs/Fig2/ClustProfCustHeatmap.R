...
keggComplete$Cluster = factor(keggComplete$Cluster, levels =  c('CA1', 'CA2', 'CA3', 'DG', 'GABA', 'ODC', 'OPC', 'MG', 'SUB'))
...
topN = "5"
typeGenes = "All"
png(filename = paste0(targDir,"ClustProf_Top_", topN, "_", typeGenes, "_Genes_2023-11-15.png"), width = 22, height = 16, units = "in", res = 300)
print(curHeatMap)
dev.off()